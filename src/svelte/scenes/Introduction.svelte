...
<div class="main">
    ...
    <div class="sideToSide">
        ...
        <div class="par">
            We can combine a <span class="math">{numbers[0]}</span>-symbol with
            a <span class="math">{numbers[1]}</span>-symbol to generate a <span class="math">({numbers[0]}*{numbers[1]}=
            {numbers[0]*numbers[1]})</span>-symbol.
        </div>
    </div>
    <div class="par">
